  ...
  return (
    <div className="flex flex-col bg-teal-500 w-screen fixed z-1">
      <div className="flex flex-row ">
        ...
        <div className="flex gap-2  border-r-2 border-gray-400 border-b-2 pt-3 pb-2  w-70">
          <img
            className="scale-170 h-15"
            src="public/logo.png"
            alt="Img.logo"
          />
          <h1 className="text-2xl font-bold font-serif mt-5">Study Buddy</h1>
        </div>
        {/* nav(top bar)- toogle */}
