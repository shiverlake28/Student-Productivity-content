...
function Profile() {
  ...
  return (
    <div className="flex flex-col min-h-screen w-screen bg-[rgba(197,231,244,0.57)] overflow-y-auto">
      <div className=" flex flex-col justify-end bg-[url('/profile_background.webp')] bg-cover h-72 w-312 bg-center">
      ...
      <div className=" h-120 w-80 border border-gray-200 rounded-2xl mt-40 ml-2 text-3xl">
        <div className="flex w-screen">
          ...
          <div className="flex flex-col gap-10 ml-30 border-l text-2xl -mt-40">
            ...
            <p className="border border-gray-400 w-239 -mt-6"></p>
            <h1 className="ml-5  text-gray-600">Theme</h1>
            <p className="ml-5">button dark light </p>
            <p className="border border-gray-400 w-239 -mt-6"></p>
